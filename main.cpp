...
int main()
{
    ...
    TestRoom testRoom(Rect{0,0,static_cast<float>(screenWidth),static_cast<float>(screenHeight)});
    ...
    Game::initScriptWrapper();

    try {

        App Application(Vec2{static_cast<float>(screenWidth),static_cast<float>(screenHeight)});
